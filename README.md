...
- [Eclipse](https://github.com/Reisonancia/Eclipse) `Founder` `Lead Developer` — Main project. Automation frameworks for Discord & Guilded.
- [Luna](https://github.com/Reisonancia/Luna) `Founder` `Principal Systems Administrator` - Eclipse subproject. Distributed computing project.
- [Sol](https://github.com/Reisonancia/Sol) `Founder` `Principal Author` - Eclipse subproject. University coursework repository.
- [Societas](https://beacons.ai/reisonancia) `Founder` `Principal Contributor` - Eclipse subproject. Social media network project.
